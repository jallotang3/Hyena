...
extern char* setup(char* baseDir, char* workingDir, char* tempDir, int mode, char* listen, char* secret, long long statusPort, GoUint8 debug);
...
extern char* AddGrpcClientPublicKey(char* clientPublicKey);
